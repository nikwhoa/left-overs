        ...
        return (
            <Col className='col-12 col-lg-3'>
                <InputGroup onClick={e => this.onDropDownButton(e.target.nodeName)} className="mb-3">
                    ...
                    <FormControl type='number' value={this.state.title === 'Ширина' ? this.state.value : ''} ref={this.dropdownRef} onChange={(e) => { this.props.updateWidth(e.currentTarget.value, 'width'); this.inputHandler(e.currentTarget.value) }} aria-label="Text input with dropdown button" />
                </InputGroup>
            </Col>
        )
    }
